...
public class ModifyCustomerJFrame extends JFrame implements MouseListener {
	// 定义全局组件
	...
	public ModifyCustomerJFrame(CustomerManagerJPanel parentPanel, JTable table, int selectedRow) {
	...
	private void initContentPanel() {
		...
		cutomeraddress = new JTextField((String) table.getValueAt(selectedRow, 6));
		lastdeliverdate = new JTextField((String) table.getValueAt(selectedRow, 7));
